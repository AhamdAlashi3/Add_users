    ...
    <div class="wrapper">
                    ...
                    <ul class="nav navbar-nav">
                        ...
                        <li class="dropdown user user-menu">
                            ...
                            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                                ...
                                <img src="{{ asset('cms/dist/img/user2-160x160.jpg') }}" class="user-image"
                                    alt="User Image">
        ...
        <aside class="main-sidebar">
            ...
            <section class="sidebar">
                ...
                <ul class="sidebar-menu">
                    ...
                    <li class="active"><a href="{{ route('dashboard') }}"><i class="fa fa-link"></i> <span>عرض
                                المستخدمين</span></a></li>
                    <li><a href="{{ route('user.create') }}"><i class="fa fa-link"></i> <span>إنشاء مستخدم</span></a>
                    </li>
                </ul><!-- /.sidebar-menu -->
            </section>
            <!-- /.sidebar -->
        ...
        <div class="content-wrapper">
            ...
            <section class="content-header">
                <h1>
                    عرض المستخدمين
                    <small>صفحة عرض المستخدمين</small>
                </h1>
                <ol class="breadcrumb">
